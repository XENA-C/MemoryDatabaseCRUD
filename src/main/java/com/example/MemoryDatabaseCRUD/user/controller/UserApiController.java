package com.example.MemoryDatabaseCRUD.user.controller;

import com.example.MemoryDatabaseCRUD.user.model.UserEntity;
import com.example.MemoryDatabaseCRUD.user.service.UserService;
...
public class UserApiController {
    ...
    //findBy id -> pathvariable
     ...
     public UserEntity findOne(
        ...
        return response.get(); //null일 경우 null return
         //.get()
    }
